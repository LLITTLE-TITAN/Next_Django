                    ...
                    <div className="card p-fluid font-medium text-base">
                        <div className="formgrid grid">
                            <div className='flex-col field col'>
                                <div className="field col">
                                    ...
                                    <Dropdown id="account" className="text-gray-700" value={dropdownItem} onChange={(e) => setDropdownItem(e.value)} options={dropdownItems} optionLabel="account" placeholder="Select One"></Dropdown>
                                </div>
                                <div className="field col" id="account-error" aria-live="polite" aria-atomic="true">
                        ...
                        <div className="formgrid grid">
                            <div className='flex-col field col'>
                                ...
                                <div className="field col" id="job-error" aria-live="polite" aria-atomic="true">
                                    {state.errors?.job &&
                        ...
                        <div className="formgrid grid">
                            <div className='flex-col field col'>
                                <div className="field col">
                                    ...
                                    <InputText id="location" name="location" type="text" placeholder="Enter a location" required />
                                </div>
                                <div className="field col" id="location-error" aria-live="polite" aria-atomic="true">
                        ...
                        <div className="formgrid grid">
                            <div className='flex-col field col'>
                                ...
                                <div className="field col" id="state-error" aria-live="polite" aria-atomic="true">
                                    {state.errors?.state &&
                            ...
                            <div className='flex-col field col'>
                                <div className="field col">
                                    ...
                                    <InputText id="length" name="length" type="text" placeholder="Long term" required />
                                </div>
                        ...
                        <div className="formgrid grid">
                            ...
                            <div className='flex-col field col'>
                                <div className="field col">
                                    ...
                                    <InputText id="length" name="restriction" type="text" placeholder="W2 or C2C" required />
                                </div>
                                <div className="field col" id="phone-error" aria-live="polite" aria-atomic="true">
                                    {state.errors?.phone &&
                                        state.errors.phone.map((error: string) => (
                            ...
                            <div className="field col-6">
                                ...
                                <div className='flex-col field col'>
                                    <div className="field text-gray-500">
                                        ...
                                        <InputText id="name2" type="text" placeholder="example:http://www.validurl.com" />
                                    </div>
                                    <div className="field col"></div>
                                </div>
                                <div className='flex row'>
                                    <div className="field col-6">
                                        <div className="field-checkbox">
                                            ...
                                            <label className="bg-transparent text-gray-500" htmlFor="city1">no opt</label>
                                        </div>
                                        <div className="field-checkbox">
                                            <input type="checkbox" id="city2"></input>
                                            <label className="bg-transparent text-gray-500" htmlFor="city2">W2 only</label>
                                        </div>
                                        <div className="field-checkbox">
                                            <input type="checkbox" id="city3"></input>
                                            <label className="bg-transparent text-gray-500" htmlFor="city3">H1 transfer allowed</label>
                                        </div>
                                    </div>
                                    ...
                                    <div className="field col-6">
                                        <div className="field-checkbox">
                                            ...
                                            <label className="bg-transparent text-gray-500" htmlFor="city4">Remote/Telecommute</label>
                                        </div>
                                        <div className="field-checkbox">
                                            <input type="checkbox" id="city5"></input>
                                            <label className="bg-transparent text-gray-500" htmlFor="city5">Active</label>
                                        </div>
                                        <div className="field-checkbox">
                                            <input type="checkbox" id="city6"></input>
                                            <label className="bg-transparent text-gray-500 text-sm" htmlFor="city6">Send ConstantContact emails</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
